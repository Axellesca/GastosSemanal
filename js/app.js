...
function preguntarPresupuesto(){
    ...
    presupuesto = new Presupuesto(presupuestoUsuario);//Paso como parámetro el presupuesto del prompt
...
function agregarGastos(e){
    ...
    presupuesto.nuevoGasto(gasto);//Añade un nuevo gasto
    ...
    formulario.reset();//Reinicia el formulario al añadir un objeto.
}
